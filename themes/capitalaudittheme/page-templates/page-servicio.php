<?php /*Template Name: Page Servicios Template */ ?>
...
<!-- Obtener El primer Servicio por orden -->
<?php  
	$args = array(
		'order'          => 'ASC',
		'orderby'        => 'menu_order',
	...
	<div class="container">
		<ul>
			<?php foreach( $servicios as $serv ) : ?>
				<li> <a class="<?= $servicio->ID == $serv->ID ? 'active' : '' ?>" href="<?= $serv->guid ?>"><?= $serv->post_title ?> </a> </li>
			<?php endforeach; ?>
		</ul>
	</div> <!-- /.container -->
	...
	<section class="pageWrapper__content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-6">
				...
				<!-- Imagen Destacada -->
				<?php 
					$feat_image = get_the_post_thumbnail( $servicio->ID , 'full' , array('class'=>'img-fluid center-block') );
					if( !empty( $feat_image )  ) : ?>
